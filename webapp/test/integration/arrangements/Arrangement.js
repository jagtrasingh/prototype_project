sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("open/sap/MasterDetail/test/mockServer.html");
		sHash = sHash || "";
	...
	return Opa5.extend("open.sap.MasterDetail.test.integration.arrangements.Arrangement", {
