...
sap.ui.define([
		...
		"sap/ui/Device",
		"open/sap/MasterDetail/model/formatter"
	], function (BaseController, JSONModel, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, formatter) {
		"use strict";

		return BaseController.extend("open.sap.MasterDetail.controller.Master", {
			...
			onOpenViewSettings : function (oEvent) {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("open.sap.MasterDetail.view.ViewSettingsDialog", this);
